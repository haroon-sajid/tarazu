...
`extraction/`, `matching/`, `rules/`, `analytics/`, `assistant/`, and
`reports/`. Boundaries mirror a microservice split, so any module can later be
...
- `matching/`, `rules/`, and `analytics/` must never import any AI client.
